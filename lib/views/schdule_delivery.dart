...
class SchduleDeliveryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final viewModel = Provider.of<ScheduleDeliveryViewModel>(context);
                      ...
                      ElevatedButton(
                          onPressed: () {
                            if (viewModel.controllers[0].text.isEmpty ||
                              ...
                              print(viewModel.controllers[0].text);
                              print(viewModel.controllers[1].text);
                              errorToast("Input both fields");
                            } else {
                              context.push("/add-details/schedule");
                            }
                          },
                          child: const Text(
                            "Next",
